...
class JoinKitchenToolsScreen extends StatefulWidget {
  @override
  _JoinKitchenToolsScreenState createState() => _JoinKitchenToolsScreenState();
}

class _JoinKitchenToolsScreenState extends State<JoinKitchenToolsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(isArabic ? "أدوات المطبخ" : "Kitchen Tools",
            style: TextStyle(
                fontSize: 26,
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                isArabic
                    ? 'اسحب أداة المطبخ إلى المكان المناسب'
                    : 'Drag the kitchen tool to the correct place',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 28,
                  fontWeight: FontWeight.bold,

...
class JoinVegetableScreen extends StatefulWidget {
  @override
  _JoinVegetableScreenState createState() => _JoinVegetableScreenState();
}

class _JoinVegetableScreenState extends State<JoinVegetableScreen>
  ...
  final List<Map<String, dynamic>> _targets = [
    {'id': 1, 'image': 'assets/vegetables/carrot.jpg'},
    {'id': 2, 'image': 'assets/vegetables/cucumber.jpg'},
    {'id': 3, 'image': 'assets/vegetables/tomato.jpg'},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(isArabic ? "الخضروات" : "Vegetables",
            style: TextStyle(
                fontSize: 26,
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                isArabic
                    ? 'اسحب الخضار إلى المكان المناسب'
                    : 'Drag the vegetable to the correct place',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 28,
                  fontWeight: FontWeight.bold,

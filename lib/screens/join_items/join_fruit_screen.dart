...
class JoinFruitScreen extends StatefulWidget {
  @override
  _JoinFruitScreenState createState() => _JoinFruitScreenState();
}

class _JoinFruitScreenState extends State<JoinFruitScreen>
  ...
  final List<Map<String, dynamic>> _targets = [
    {'id': 1, 'image': 'assets/fruits/apple.jpg'},
    {'id': 2, 'image': 'assets/fruits/banana.jpg'},
    {'id': 3, 'image': 'assets/fruits/orange.jpg'},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(isArabic ? "الفاكهة" : "Fruits",
            style: TextStyle(
                fontSize: 26,
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                isArabic
                    ? 'اسحب الفاكهة إلى المكان المناسب'
                    : 'Drag the fruit to the correct place',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 28,
                  fontWeight: FontWeight.bold,

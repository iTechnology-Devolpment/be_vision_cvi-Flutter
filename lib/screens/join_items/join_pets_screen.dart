...
class JoinPetsScreen extends StatefulWidget {
  @override
  _JoinPetsScreenState createState() => _JoinPetsScreenState();
}

class _JoinPetsScreenState extends State<JoinPetsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(isArabic ? "الحيوانات الأليفة" : "Pets",
            style: TextStyle(
                fontSize: 26,
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                isArabic
                    ? 'اسحب الحيوان الأليف إلى المكان المناسب'
                    : 'Drag the pet to the correct place',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 28,
                  fontWeight: FontWeight.bold,

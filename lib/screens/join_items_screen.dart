...
class JoinItemsScreen extends StatefulWidget {
  @override
  _JoinItemsScreenState createState() => _JoinItemsScreenState();
}

class _JoinItemsScreenState extends State<JoinItemsScreen>
  ...
  void _handleMatch(int itemId, int targetId) {
    if (itemId == targetId) {
      ...
      speak(isArabic ? '!صح، $colorName $shapeName' : 'Correct! $colorName $shapeName');
      vibrate();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(isArabic ? "التوصيل" : "Join Items",

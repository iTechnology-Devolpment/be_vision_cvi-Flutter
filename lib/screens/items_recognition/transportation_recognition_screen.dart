...
class TransportationRecognitionScreen extends StatefulWidget {
  @override
  _TransportationRecognitionScreenState createState() => _TransportationRecognitionScreenState();
}

class _TransportationRecognitionScreenState extends State<TransportationRecognitionScreen>
  ...
  Map<String, Map<String, String>> translations = {
    'ar': {
      ...
      'appTitle': 'وسائل النقل',
      'currentItem': ''
    },
    'en': {
      'next': 'Next',
      'languageChanged': 'Language changed',
      'appTitle': 'Transportations',
